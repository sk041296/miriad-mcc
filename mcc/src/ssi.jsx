...
import { C, fmt, hojeISO, dataBR, Card, Btn, Lbl, inp, listar, criar, editar, casarEapImport, verificarImport, VerifBanner, numBR, extrairItensPlanilha } from "./core.jsx";
  ...
  const importarPlanilha = async (file) => {
    ...
    try {
      ...
      const melhores = itensP.map((it) => {
        ...
        if (c) casados++;
        return { eap_codigo: c || it.codigo, descricao: it.descricao, servico: it.descricao, quantidade: it.qtde, unidade: it.unidade };
      });
